...
$(document).ready(function(){
    ...
    //PHOTO
     $("#lastPic").mouseover(function() { 
        $(this).fadeOut(function(){
            $(this).attr("src", 'img/blackandwhite.png');
            $(this).fadeIn();
        });
    }).mouseout(function() {
        $(this).fadeOut(function(){
            $(this).attr("src", 'img/colors.pn');
            $(this).fadeIn();
        });
    });
    //Main Logo
    $("#logobanner").mouseover(function() { 
        $(this).fadeOut(function(){
            $(this).attr("src", 'img/sponsors/color/logo.png');
            $(this).fadeIn();
        });
    }).mouseout(function() {
        $(this).fadeOut(function(){
            $(this).attr("src", 'img/sponsors/black/logo black and white.png');
            $(this).fadeIn();
        });
    });
